...
</div><div class="form-group {{ $errors->has('bill_date') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('gross_payment') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="gross_payment" type="text" id="gross_payment" onkeyup="total()" value="{{ $bill->gross_payment or ''}}" required >
...
<div class="form-group {{ $errors->has('vat') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="vat" type="text" onkeyup="total()" id="vat" value="{{ $bill->vat or ''}}" required>
        {!! $errors->first('vat', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('ait') ? 'has-error' : ''}}">
    <label for="ait" class="col-md-4 control-label">{{ 'Ait' }}</label>
    <div class="col-md-6">
        <input class="form-control" name="ait" type="text" id="ait" onkeyup="total()" value="{{ $bill->ait or ''}}" required>
