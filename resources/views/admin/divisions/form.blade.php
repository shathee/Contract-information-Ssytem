<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="name" type="text" id="name" value="{{ $division->name or ''}}" >
    ...
    <div class="col-md-6">
        <input class="form-control" name="bn_name" type="text" id="bn_name" value="{{ $division->bn_name or ''}}" >
