...
<div class="card">
  ...
  <div class="card-body">
    <h5 class="card-title text-right">
        <a href="{{ url('/admin/districts/create') }}" class="btn btn-success btn-sm" title="Add New District">
            <i class="fa fa-plus" aria-hidden="true"></i> Add New
        </a>
    </h5>
    <form method="GET" action="{{ url('/admin/districts') }}" accept-charset="UTF-8" class="navbar-form navbar-right" role="search">
    ...
    <div class="table-responsive">
        <table class="table table-borderless">
            <thead>
                <tr>
                    <th>#</th><th>Division Id</th><th>Name</th><th>Bn Name</th><th>Actions</th>
                </tr>
            </thead>
            <tbody>
        ...
        <div class="pagination-wrapper pagination"> {!! $districts->appends(['search' => Request::get('search')])->render() !!} 
        </div>
    </div>
