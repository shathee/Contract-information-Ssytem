            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('/admin/circles/create') }}" class="btn btn-success btn-sm" title="Add New Circle">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ url('/admin/circles') }}" accept-charset="UTF-8" class="navbar-form navbar-right" role="search">
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($circles as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/admin/circles' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                            ...
                            <div class="pagination-wrapper"> {!! $circles->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
