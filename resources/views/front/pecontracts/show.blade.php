    ...
    <div class="table-responsive">
        <table class="table table-borderless">
            <tbody>
                ...
                <tr><th> Peoffice Id </th><td> {{ $pecontract->peoffice->name }} </td></tr>
                <tr><th> Circle Id </th><td> {{ $pecontract->circle->name }} </td></tr>
                <tr><th> Zone Id </th><td> {{ $pecontract->zone->name }} </td></tr>
