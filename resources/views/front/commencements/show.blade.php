    ...
    <div class="table-responsive">
        <table class="table table-borderless">
            <tbody>
                ...
                <tr><th> Commencement Memo No </th><td> {{ $commencement->commencement_memo_no }} </td></tr><tr><th> Commencement Memo Date </th><td> {{ $commencement->commencement_memo_date }} </td></tr><tr><th> Contractors Legal Title </th><td> {{ $commencement->contractors_legal_title }} </td></tr>
            </tbody>
        </table>
    </div>
